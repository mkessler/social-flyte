class TwitterToken < ApplicationRecord
  ...
  validates :organization_id, :user_id, :encrypted_token, :encrypted_token_iv, :encrypted_secret, :encrypted_secret_iv, :network_user_name, :network_user_image_url, presence: true
